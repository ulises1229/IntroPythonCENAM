...
## Fechas y horarios
#### Fechas: 14 de agosto - 16 de diciembre de 2022
...
## Prerequisitos
## Prerequisitos
<ol><li>Computadora personal</li> <li> Cuenta de Gmail</li><li>Conexión a internet</li></ol>
...
| :-------------: |:-------------:|:-----| :-----:|:-----: |
| Día 0       | Instalación de Prerrequisitos (Opcional si se desea trabajar con su computadora) | <ul>Instalación de:<ul><li>Python</li><li>Jupyter</li><li>Librerías</li><ul></ul> | [Ver página](http://132.247.186.49/courses/python/) | [Video Instalación](https://www.youtube.com/watch?v=1ETiwXo0lg4&feature=emb_title)|
